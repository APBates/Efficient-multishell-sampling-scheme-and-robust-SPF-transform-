function [dlmn, d_recon, cost_func_vec] = SPF_denoise_MM_real_data(d_noisy_vec, noise_std, lambda_l,lambda_n,L,N,x,zeta, ms_XYZB,diff_time)
...
while(1) %until convergence
    ...
    if (change < 1e-2 || iter3 >50) %when converged
